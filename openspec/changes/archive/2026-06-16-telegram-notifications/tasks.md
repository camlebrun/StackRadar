...
- [x] 5.1 Run `pytest tests/test_telegram_notifier.py` — all tests pass
- [x] 5.2 Run existing test suite (`pytest`) to confirm no regressions
- [x] 5.3 Do a local dry-run with `TELEGRAM_BOT_TOKEN` set and a test channel ID to verify message format and delivery
